...
const editAvailabilityInput = document.getElementById("editAvailability"); // Input for the book availability
...
function populateForm(book) {
  ...
  editAvailabilityInput.value = book.availability; // Set the availability input value
